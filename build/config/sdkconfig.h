...
#define CONFIG_COMPILER_STACK_CHECK_MODE_ALL 1
...
#define CONFIG_HEAP_TRACING_STANDALONE 1
#define CONFIG_HEAP_TRACING 1
#define CONFIG_HEAP_TRACING_STACK_DEPTH 2
...
#define CONFIG_LWIP_IRAM_OPTIMIZATION 1
...
#define CONFIG_LWIP_AUTOIP_TRIES 2
